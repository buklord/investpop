...
export default function WithdrawPage() {
  ...
  // KYC gate — block withdrawals until verified
  const ks = kycStatus || 'PENDING'
  if (ks !== 'APPROVED') {
    const kycMessages = {
      PENDING:   { icon: '🔒', title: 'Verification Required', desc: 'To withdraw real funds you must complete identity verification (KYC). This takes less than 5 minutes.', cta: 'Start Verification', href: '/kyc/verify', color: 'border-amber-500/30 bg-amber-500/5' },
      SUBMITTED: { icon: '⏳', title: 'Verification In Progress', desc: 'Your documents are under review. You will be notified once your account is verified.', cta: 'Check Status', href: '/kyc/verify', color: 'border-blue-500/30 bg-blue-500/5' },
