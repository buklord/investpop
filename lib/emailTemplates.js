...
function buttonHtml({ href, label }) {
  ...
  return `
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:20px auto 0;">
      <tr>
        <td align="center" bgcolor="#d4a017" style="border-radius:12px;">
          <a href="${safeHref}"
             style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:800;text-decoration:none;color:#1a1200;-webkit-text-fill-color:#1a1200;border-radius:12px;">
            ${safeLabel}
          </a>
        </td>
      </tr>
      ...
      <tr>
        <td align="center" style="padding:34px 16px;" class="mobile-padding">
          <table role="presentation" cellpadding="0" cellspacing="0" align="center" style="width:100%;max-width:600px;">
            ...
            <tr>
              <td align="center" style="padding-top:14px;font-size:12px;line-height:1.6;color:#d4a017;-webkit-text-fill-color:#d4a017;text-align:center;">${footer || ''}</td>
            </tr>
          </table>
        </td>
      </tr>
