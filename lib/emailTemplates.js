...
function getBaseUrl() {
  ...
  return 'https://www.kartomtrades.com'
}

function getLogoUrl() {
  return `${getBaseUrl()}/kartom-k.svg`
}
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 14px;">
        <tr>
          <td style="vertical-align:middle;">
            <img src="${logoUrl}" width="40" height="40" alt="Kartomtrades" style="display:block;border:0;outline:none;" />
          </td>
          <td style="vertical-align:middle;padding-left:10px;">
            <div style="font-size:14px;font-weight:900;letter-spacing:0.2px;color:#111827;">Kartomtrades</div>
            <div style="font-size:12px;color:#6b7280;">Secure trading platform</div>
          </td>
        </tr>
      </table>

      <div style="background:linear-gradient(90deg,#2563EB 0%,#111827 100%);border-radius:16px;padding:1px;">
        <div style="background:#ffffff;border-radius:15px;padding:22px;">
          <div style="font-size:18px;font-weight:900;margin:0 0 10px;">${safeTitle}</div>
          <div style="font-size:14px;line-height:1.6;color:#111827;">${body}</div>
        </div>
      </div>

      <div style="margin-top:14px;font-size:12px;line-height:1.5;color:#6b7280;">${footer || ''}</div>
    </div>
  </body>
</html>`
}
