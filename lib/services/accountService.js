...
// Demo trading starts with practice funds; real balance starts at 0.
...
export class AccountService {
  ...
  async getAccount() {
    ...
    if (accounts.length === 0) {
      ...
      return {
        ...
        currency: 'USD',
        trading_mode: 'REAL',
        demo_balance: DEMO_STARTING_BALANCE,
        real_balance: 0,
        created_at: new Date(),
        updated_at: new Date()
      }
  ...
  async getAccountSummary() {
    ...
    const returnPercent = equity > 0 && TRADING_CONFIG.STARTING_BALANCE > 0 ? ((equity / TRADING_CONFIG.STARTING_BALANCE) - 1) * 100 : 0
