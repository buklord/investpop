...
export class TradeService {
  ...
  async executeSell(params) {
    const {
      asset, quantity, marketPrice, executedPrice, slippagePercent,
      totalValue, fee, existingPosition, accountType: accountTypeFromCaller
    } = params
    ...
    this.triggerCopyTrades({
      ...
      executedPrice,
      price: marketPrice,
      takeProfit: existingPosition.take_profit,
      stopLoss: existingPosition.stop_loss,
