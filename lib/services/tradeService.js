...
export class TradeService {
  ...
  async triggerCopyTrades(tradeData) {
    try {
      ...
      console.log(`[DEBUG] User ${this.userId} role: ${userRole}`)
      if (!userRole || !['ADMIN', 'SUPER_ADMIN'].includes(userRole)) {
        // Not a leader, skip
        console.log(`[DEBUG] User is not a leader, skipping copy trades`)
        return
      }
  ...
  async triggerCopyCloses(closeData) {
    try {
      ...
      if (!userRole || !['ADMIN', 'SUPER_ADMIN'].includes(userRole)) {
        // Not a leader, skip
        console.log(`[DEBUG] User is not a leader, skipping copy closes`)
        return
      }
